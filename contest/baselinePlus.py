...
class OffensiveReflexAgent(ReflexCaptureAgent):
  ...
  def getFeatures(self, gameState, action):
    ...
    # Compute distance to nearest protector that has small scare time 
    ...
    if len(protectors) > 0:
      ...
      features['protectorDistance'] = min(dists)
  ...
  def getWeights(self, gameState, action):
    return {'successorScore': 100, 'distanceToFood': -2, 'protectorDistance': 10, 'distanceToCapsule': -2, 'capsulePresented': -20, 'stop': -100, 'reverse': -2}
